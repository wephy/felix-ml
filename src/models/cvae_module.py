...
class VAELitModule(LightningModule):
    ...
    def forward(self, trues: torch.Tensor, conditions: torch.Tensor):
        return self.net(trues, conditions)

    def on_train_start(self):
        self.val_loss.reset()

    def model_step(self, batch: Any):
        trues, conditions = batch
        recons, mu, logvar = self.forward(trues, conditions)
    ...
    def on_test_epoch_end(self):
        torch.save(self.net.state_dict(), "cvae.pt")
